  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-brand-hover': 'linear-gradient(135deg, #38bdf8 0%, #818cf8 50%, #c084fc 100%)',
        'gradient-subtle': 'linear-gradient(135deg, rgba(14, 165, 233, 0.1) 0%, rgba(168, 85, 247, 0.1) 100%)',
