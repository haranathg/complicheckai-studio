                    ...
                    <div className={`flex items-center gap-3 mt-2 text-xs ${theme.textMuted}`}>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-md transition-colors ${isDark ? 'hover:bg-sky-900/30 text-slate-500 hover:text-sky-400' : 'hover:bg-sky-50 text-slate-400 hover:text-sky-600'}`}
                          title="Edit"
                        ...
                        {annotation.status === 'open' && (
                          <button
                            ...
                            className={`p-1.5 rounded-md transition-colors ${isDark ? 'hover:bg-green-900/30 text-slate-500 hover:text-green-400' : 'hover:bg-green-50 text-slate-400 hover:text-green-600'}`}
                            title="Resolve"
                        ...
                        <div className="relative group/menu">
                          <button
                            ...
                            className={`p-1.5 rounded-md transition-colors ${isDark ? 'hover:bg-slate-700/50 text-slate-500 hover:text-slate-300' : 'hover:bg-slate-100 text-slate-400 hover:text-slate-600'}`}
                            title="More actions"
                          ...
                          <div className={`absolute right-0 top-full mt-1 py-1 rounded-lg shadow-lg border opacity-0 invisible group-hover/menu:opacity-100 group-hover/menu:visible transition-all z-50 min-w-[100px] ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                setDeleteAnnotationId(annotation.id);
                              }}
                              className={`w-full text-left px-3 py-1.5 text-xs flex items-center gap-2 transition-colors ${isDark ? 'text-red-400 hover:bg-red-900/30' : 'text-red-600 hover:bg-red-50'}`}
                            >
                              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
