        ...
        {requiresNewPassword ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded transition-colors ${isDark ? 'text-slate-500 hover:text-slate-300' : 'text-slate-400 hover:text-slate-600'}`}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <a
                href="mailto:support@cognaify.com.au?subject=Password%20Reset%20Request"
                className={`text-xs mt-1.5 inline-block ${isDark ? 'text-sky-400 hover:text-sky-300' : 'text-sky-600 hover:text-sky-500'} transition-colors`}
              >
                Forgot password?
              </a>
            </div>
